...
const Footer = () => {
  return (
    <footer className="relative w-full bg-gradient-to-br  from-teal-900 via-primary to-teal-600 dark:bg-background/50 pt-20 pb-12 overflow-hidden border-t-2 border-gray-700/5 rounded-md">
