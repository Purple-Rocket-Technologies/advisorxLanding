  ...
  return (
    <div className="min-h-screen bg-background dark:bg-black text-neutral-dark dark:text-base-white flex flex-col items-center overflow-x-hidden">
      ...
      <WhyItMatters />
        ...
        <section className="w-full py-20 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
          <div className="absolute inset-0">
            <motion.div
              className="absolute top-1/2 left-1/4 w-96 h-96 bg-primary/3 rounded-full blur-3xl"
              animate={{
                scale: [1, 1.2, 1],
                opacity: [0.2, 0.4, 0.2],
              }}
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="text-center mb-16">
              ...
              >
                Join thousands of professionals who have transformed their business with AI-powered lead generation
              </motion.p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
              {[
                { value: "2,500+", label: "Active Users", desc: "Professionals worldwide" },
                { value: "98%", label: "Satisfaction Rate", desc: "Customer approval" },
                { value: "45M+", label: "Emails Sent", desc: "Total outreach volume" },
                { value: "24/7", label: "Support", desc: "Enterprise-grade assistance" }
              ].map((stat, index) => (
                <motion.div
                  key={stat.label}
                ...
                >
                  <div className="relative group">
                    <div className="absolute -inset-1 bg-gradient-to-r from-primary/20 to-secondary/20 rounded-2xl blur opacity-25 group-hover:opacity-60 transition duration-300"></div>
                    <div className="relative bg-white rounded-2xl p-8 border border-gray-200/50 hover:border-primary/30 transition-all duration-300">
            ...
            <motion.div
              ...
              className="flex flex-wrap items-center justify-center gap-8 pt-12 border-t border-gray-200"
            >
